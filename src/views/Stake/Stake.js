...
function CompoundModal(props) {
  const { isVisible, setIsVisible, rewardRouterAddress, library, chainId, setPendingTxns, wrappedTokenSymbol } = props;
  ...
  const onClickPrimary = () => {
    ...
    callContract(
      ...
      "handleRewards",
      [shouldClaimWeth || shouldConvertWeth, shouldConvertWeth, shouldAddIntoQLP],
      {
...
function ClaimModal(props) {
  ...
  const onClickPrimary = () => {
    ...
    const contract = new ethers.Contract(rewardRouterAddress, RewardRouter.abi, library.getSigner());
    callContract(chainId, contract, "handleRewards", [shouldClaimWeth, shouldConvertWeth, false], {
