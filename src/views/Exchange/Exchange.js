...
export const Exchange = forwardRef((props, ref) => {
  ...
  const { data: usdqSupply } = useSWR([`Exchange:usdqSupply:${active}`, chainId, usdqAddress, "totalSupply"], {
  ...
  useEffect(() => {
    ...
    let currentTokenPriceStr = selectedToken
      ? formatAmount(selectedToken.maxPrice, USD_DECIMALS, selectedToken.displayDecimals, true)
      : "";
    let title = selectedToken
