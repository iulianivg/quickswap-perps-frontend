...
function getSwapLimits(infoTokens, fromTokenAddress, toTokenAddress) {
  ...
  if (!fromInfo?.maxUsdqAmount) {
    maxInUsd = bigNumberify(0);
    maxIn = bigNumberify(0);
  } else {
    maxInUsd = fromInfo.maxUsdqAmount
      .sub(fromInfo.usdqAmount)
            ...
            <div style={{ paddingLeft: "0.7rem" }}>
              <div className="Exchange-swap-section">
                <div className="Exchange-swap-section-top">
                  ...
                  >
                    Mark: {formatAmount(position.markPrice, USD_DECIMALS, position.indexToken.displayDecimals, true)}
                  </div>
                </div>
                <div className="Exchange-swap-section-bottom">
                  <div className="Exchange-swap-input-container">
          ...
          <div className="PositionEditor-info-box">
            ...
            <div className="PositionEditor-keep-leverage-settings">
              <Checkbox isChecked={keepLeverage} setIsChecked={setKeepLeverage}>
                <span style={{ marginLeft: 0, padding: 0 }} className="muted font-sm">
